...
namespace MediChain.Module7.Tests
{
    public class MedicalApprovalServiceTests
    {
        ...
        {
            double result = _service.CalculatePatientCoPay("Premium", 30, 1000);
        ...
        {
            double result = _service.CalculatePatientCoPay("Basic", 30, 1000);
        ...
        {
            double result = _service.CalculatePatientCoPay("Basic", 30, 200);
